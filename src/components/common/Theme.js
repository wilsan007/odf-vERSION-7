...
export const T = {
  fr: {
    ...
    serviceTabs: ["Services", "Suppression"],
    deleteTabTitle: "Suppression de service",
    deleteTabSearchPlaceholder: "Rechercher le service par CID…",
    deleteTabSelectService: "Sélectionnez un service à supprimer",
    deleteTabNoResult: "Aucun service trouvé pour ce CID",
    deleteTabConfirmTitle: "Confirmation de suppression",
    deleteTabConfirmMsg: "Vous êtes sur le point de supprimer le service suivant. Cette action est irréversible.",
    deleteTabPasswordLabel: "Entrez votre mot de passe pour confirmer",
    deleteTabPasswordPlaceholder: "Mot de passe",
    deleteTabWrongPassword: "Mot de passe incorrect. Suppression annulée.",
    deleteTabSuccess: "Service supprimé avec succès.",
    deleteTabDeleting: "Suppression en cours…",
  },
  en: {
    appName: "ODF Manager", appSub: "Omega Tech · Djibouti Telecom",
    ...
    serviceTabs: ["Services", "Deletion"],
    deleteTabTitle: "Service deletion",
    deleteTabSearchPlaceholder: "Search service by CID…",
    deleteTabSelectService: "Select a service to delete",
    deleteTabNoResult: "No service found for this CID",
    deleteTabConfirmTitle: "Deletion confirmation",
    deleteTabConfirmMsg: "You are about to delete the following service. This action is irreversible.",
    deleteTabPasswordLabel: "Enter your password to confirm",
    deleteTabPasswordPlaceholder: "Password",
    deleteTabWrongPassword: "Incorrect password. Deletion cancelled.",
    deleteTabSuccess: "Service deleted successfully.",
    deleteTabDeleting: "Deleting…",
  }
};
